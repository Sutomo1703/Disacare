...
class AdminLocationReviewPage extends StatefulWidget {
  final String locationName;
  final String? docId;
  const AdminLocationReviewPage({super.key, required this.locationName, this.docId});

  @override
  State<AdminLocationReviewPage> createState() => _AdminLocationReviewPageState();
}

class _AdminLocationReviewPageState extends State<AdminLocationReviewPage> {
