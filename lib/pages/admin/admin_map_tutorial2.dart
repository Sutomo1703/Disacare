...
class AdminMapTutorialPage2 extends StatefulWidget {
  const AdminMapTutorialPage2({super.key});

  @override
  State<AdminMapTutorialPage2> createState() => _AdminMapTutorialPage2State();
}

class _AdminMapTutorialPage2State extends State<AdminMapTutorialPage2> {
