...
class _RegisterPageState extends State<RegisterPage> {
  ...
  postDetailsToFirestore() async {
    ...
    userModel.usernameholder = usernameController.text.toLowerCase();
    userModel.alamat = addressController.text;
    userModel.password = passwordRegisController.text;
    userModel.repassword = repasswordRegisController.text;
