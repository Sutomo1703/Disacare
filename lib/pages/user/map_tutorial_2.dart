...
class UserMapTutorialPage2 extends StatefulWidget {
  const UserMapTutorialPage2({super.key});

  @override
  State<UserMapTutorialPage2> createState() => _UserMapTutorialPage2State();
}

class _UserMapTutorialPage2State extends State<UserMapTutorialPage2> {
